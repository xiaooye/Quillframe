...
mod tests {
    ...
    async fn studio_plan_to_released_candidate_runs_entirely_through_rust() {
        ...
        assert!(surface_audit_request
            .user
            .contains("falsify Surface readiness"));
