  ...
  routes: {
    ...
    docs: {
      ...
      cards: [
        ...
        { eyebrow: "版本", title: "0.9.1 版本记录", body: "小说原生宿主边界、精确评审证据、mapped projection，以及已实现能力与剩余工作的明确边界。", meta: "CHANGELOG.zh-CN.md" },
      ],
    },
    changelog: {
      eyebrow: "版本状态",
      ...
      cards: [
        { title: "统一使用 0.9.1 当前身份", body: "Manifest、CLI、Studio、持久化、Project SDK、技术命名空间与文档共用同一个 Quillframe 当前身份。" },
