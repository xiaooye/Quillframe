...
const dark = tokens.app.theme.dark;
...
const lines = [
  ...
  color("BACKGROUND", dark.background), color("FOREGROUND", dark.foreground), color("MUTED", dark.muted), color("MUTED_FOREGROUND", dark.muted_foreground), color("CARD", dark.card), color("CARD_FOREGROUND", dark.card_foreground), color("BORDER", dark.border), color("PRIMARY", dark.primary), color("PRIMARY_FOREGROUND", dark.primary_foreground), color("RING", dark.ring), color("DESTRUCTIVE", dark.destructive), color("SUCCESS", dark.success), color("WARNING", dark.warning), color("SURFACE_RAISED", dark.surface_raised), color("SURFACE_OVERLAY", dark.surface_overlay), color("SURFACE_SUNKEN", dark.surface_sunken),
