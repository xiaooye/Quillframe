...
当前登记版本为 4。第三版在作者明确否决此前文青、过度周全、人物不像活人的稿件后，已不再把“更克制、更端正”当作主要目标。第四版保留这些因果与人物机制，但退出仍在生效的 Raw Draft→Surface 指令，改由一个直接 Surface Writer 实现场景合同。这仍是待作者逐篇验证的候选机制，不是文学质量提升结论。
