...
TOOLS: dict[str, Path] = {
    ...
    "context-trace": ROOT / "harness" / "context_trace.py",
    "story-workspace": ROOT / "harness" / "story_workspace.py",
    "scene-simulation-run": ROOT / "harness" / "scene_simulation_run.py",
    "event-ir": ROOT / "core" / "event_ir.py",
    ...
    "candidate-state-delta": ROOT / "quality" / "candidate_state_delta.py",
    "narrative-verification": ROOT / "quality" / "narrative_verification.py",
...
def self_test() -> int:
    checks=[(PROJECT_SDK,["self-test"]),(PROJECT_ADAPTER,["self-test"]),(SESSION,["self-test"]),(TOOLS["runtime"],["--db","/tmp/novelforge-cli-control.db","self-test"]),(TOOLS["runtime-query"],["self-test"]),(TOOLS["resume-preflight"],["self-test"]),(TOOLS["resume-command"],["self-test"]),(TOOLS["runtime-command-authorization"],["self-test"]),(TOOLS["runtime-command"],["self-test"]),(TOOLS["capabilities"],["self-test"]),(TOOLS["context-inspect"],["self-test"]),(TOOLS["context-trace"],["self-test"]),(TOOLS["story-workspace"],["self-test"]),(TOOLS["scene-simulation-run"],["self-test"]),(TOOLS["event-ir"],["self-test"]),(TOOLS["memory-tiers"],["self-test"]),(TOOLS["memory-bank"],["--db","/tmp/novelforge-cli-memory.db","self-test","--path","/tmp/novelforge-cli-memory-selftest.db"]),(TOOLS["scenario-fork"],["--db","/tmp/novelforge-cli-scenario.db","self-test","--path","/tmp/novelforge-cli-scenario-selftest.db"]),(TOOLS["settlement"],["--db","/tmp/novelforge-cli-settlement.db","self-test","--path","/tmp/novelforge-cli-settlement-selftest.db","--project-root","/tmp/novelforge-cli-settlement-project"]),(SEMANTIC,["self-test"]),(REGISTERED_CONTRACT_BINDING,["self-test"]),(PEER_BRIDGE_RECEIPT,["self-test"]),(TOOLS["quality-findings"],["self-test"]),(TOOLS["quality-taxonomy"],["self-test"]),(TOOLS["repair-policy"],["self-test"]),(TOOLS["production-readiness"],["self-test"]),(TOOLS["reader-expectation"],["--db","/tmp/novelforge-cli-reader-expectation.db","self-test","--path","/tmp/novelforge-cli-reader-expectation-selftest.db"]),(TOOLS["quality-evolution"],["--db","/tmp/novelforge-cli-quality.db","self-test","--path","/tmp/novelforge-cli-quality-selftest.db"]),(TOOLS["state-graph"],["self-test"]),(TOOLS["candidate-state-delta"],["self-test"]),(TOOLS["narrative-verification"],["self-test"]),(TOOLS["learning"],["--db","/tmp/novelforge-cli-learning.db","self-test"]),(TOOLS["learning-cycle"],["self-test","--path","/tmp/novelforge-cli-learning-cycle.db"]),(TOOLS["learning-work"],["self-test"]),(TOOLS["learning-gate"],["self-test"]),(CORPUS_TOOLS["scout"],["self-test"]),(CORPUS_TOOLS["discovery"],["self-test"]),(CORPUS_TOOLS["rights"],["self-test"]),(MCP,["--self-test"]),(TOOLS["publication"],["self-test"]),(TOOLS["semantic-acceptance"],["self-test"]),(TOOLS["bundle"],["self-test"])]
    results=[]; ok=True
