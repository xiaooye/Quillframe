...
def self_test() -> int:
    checks=[(PROJECT_SDK,["self-test"]),(PROJECT_ADAPTER,["self-test"]),(SESSION,["self-test"]),(TOOLS["runtime"],["--db","/tmp/novelforge-cli-control.db","self-test"]),(TOOLS["capabilities"],["self-test"]),(TOOLS["context-inspect"],["self-test"]),(TOOLS["memory-tiers"],["self-test"]),(TOOLS["memory-bank"],["--db","/tmp/novelforge-cli-memory.db","self-test","--path","/tmp/novelforge-cli-memory-selftest.db"]),(TOOLS["scenario-fork"],["--db","/tmp/novelforge-cli-scenario.db","self-test","--path","/tmp/novelforge-cli-scenario-selftest.db"]),(TOOLS["settlement"],["--db","/tmp/novelforge-cli-settlement.db","self-test","--path","/tmp/novelforge-cli-settlement-selftest.db","--project-root","/tmp/novelforge-cli-settlement-project"]),(SEMANTIC,["self-test"]),(TOOLS["quality-findings"],["self-test"]),(TOOLS["quality-taxonomy"],["self-test"]),(TOOLS["repair-policy"],["self-test"]),(TOOLS["production-readiness"],["self-test"]),(TOOLS["reader-expectation"],["--db","/tmp/novelforge-cli-reader-expectation.db","self-test","--path","/tmp/novelforge-cli-reader-expectation-selftest.db"]),(TOOLS["quality-evolution"],["--db","/tmp/novelforge-cli-quality.db","self-test","--path","/tmp/novelforge-cli-quality-selftest.db"]),(TOOLS["state-graph"],["self-test"]),(TOOLS["learning"],["--db","/tmp/novelforge-cli-learning.db","self-test"]),(TOOLS["learning-cycle"],["self-test","--path","/tmp/novelforge-cli-learning-cycle.db"]),(TOOLS["learning-work"],["self-test"]),(TOOLS["learning-gate"],["self-test"]),(CORPUS_TOOLS["scout"],["self-test"]),(CORPUS_TOOLS["discovery"],["self-test"]),(CORPUS_TOOLS["rights"],["self-test"]),(MCP,["--self-test"]),(TOOLS["publication"],["self-test"]),(TOOLS["semantic-acceptance"],["self-test"]),(TOOLS["bundle"],["self-test"])]
    results=[]; ok=True
    ...
    dump({"novelforge_cli_contract":"PASS" if ok else "FAIL","framework_version":FRAMEWORK_VERSION,"checks":results,"doctor":d,"settlement_runtime":"harness/settlement_runtime.py","ai_native_semantic_entry":"harness/semantic_workers/semantic_worker_router.py","semantic_catalog":"harness/semantic_workers/model_contract_catalog.json","quality_taxonomy":"quality/taxonomy.json","repair_policy":"quality/repair_policy.py","production_reader_contract":"reader.engagement_audit","production_independent_contract":"quality.production_review","aggregate_semantic_registry_present":False,"model_execution":False}); return 0 if ok else 1
