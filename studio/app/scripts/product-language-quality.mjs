...
if (failures.length) {
  ...
  console.log(JSON.stringify({ schema: "novelforge_studio_product_language_v1", status: "pass", shared_tokens: true, single_css_entrypoint: true, product_language: "novelforge-kawaii-v1" }, null, 2));
}
