...
NovelForge 把长篇小说建模为**不同规划尺度上的持久故事对象**，再配合通常不需要长期保存的场景 beat。它解决的是一个长篇连载问题：怎样让几十、几百章持续保持结构与因果，却不要求作者提前把遥远未来写到场景级细节。
...
具体距离可以由项目和 profile 调整。真正的不变量是：**越靠近执行，规划越细；越遥远，越要保留被现实剧情推翻的空间。**
