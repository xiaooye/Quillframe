# Windows Ultra-Long Production Tasks

2026-09-01 · `SYSTEM-IMPROVE`

- [x] Freeze the bilingual specification and the Shujuku-to-Rust one-way layer mapping.
- [x] Replace the product runtime, SQLite authority, CLI/local host, tests, and sidecar with Rust; remove every Python file and runtime prerequisite.
