...
2. 在 quality semantic pack 注册：
   - `reader.engagement_audit`：cold reader context、holistic causal audit、结构化 engagement artifact；
   - `quality.production_review`：fresh independent falsification review，拥有唯一 `semantic_independent` release role。
