...
- [~] T310 Run local browser/accessibility/visual E2E; production browser evidence is being regenerated.
...
- [~] T605 Run accessibility and responsive visual QA; production fail-closed browser evidence is being regenerated.
...
- [~] T608 Produce and read back the release acceptance report with unresolved external evidence.
