...
- [~] T310 执行本地 browser/accessibility/visual E2E；production 浏览器证据正在重新生成。
...
- [~] T605 执行 accessibility 与 responsive visual QA；正在重新生成 production fail-closed 浏览器证据。
...
- [~] T608 生成并回读含未解决外部证据的 release acceptance report。
