...
- Run `pnpm --filter @quillframe/product-site quality` before completing customer-facing docs work. Normal CI runs the same deterministic checker and must not invoke model APIs.
